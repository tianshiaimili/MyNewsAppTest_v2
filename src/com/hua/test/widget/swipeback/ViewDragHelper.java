...
package com.hua.test.widget.swipeback;
...
public class ViewDragHelper {
	 ...
	 * callback's
	 * {@link com.hua.test.widget.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
	 * and
	 * {@link com.hua.test.widget.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
	 ...
	 * {@link com.hua.test.widget.swipeback.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
...
//		boolean mIsEdgesTouched = (mInitialEdgesTouched[pointerId] & edges) != 0 ;
	 ...
	 * {@link com.hua.test.widget.swipeback.ViewDragHelper.Callback#getOrderedChildIndex(int)}
	 * .
	 * 
	 * @param x
	 *            X position to test in the parent's coordinate system
